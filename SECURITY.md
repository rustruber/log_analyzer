...
If you find a security vulnerability in log_analyzer, please report it through [GitHub's private vulnerability reporting](https://github.com/rustruber/log_analyzer/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact lphp@mail.ru for details.
